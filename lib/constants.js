...
, 'footer-empty': {
  ...
  , explanation: [
      'Add references, breaking changes, or issue numbers in the footer'
    , 'Footer items should be in standard Git Trailer Format'
    , 'ex. See: https://datatracker.ietf.org/doc/html/rfc6749'
    ]
  }
...
, 'references-empty': {
  ...
  , explanation: [
      'Add issue references or PR numbers in the footer'
    , 'ex. Fixes: #1234'
    , 'ex. Ref: LOG-4321'
    ]
  }
